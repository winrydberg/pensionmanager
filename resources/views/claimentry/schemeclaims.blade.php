...
@stop @section('pageheading', "Claims") @section('contentone')
<div class="row">
    <div class="col-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    $claim->audited==false)
                                    <a
                                        href="{{url('/audit?claimid='.$claim->claimid)}}"
                                        class="btn btn-xs btn-flat btn-dark"
                                        ><i class="fa fa-upload"></i> Audit</a
                                    >
                                    @endif {{-- @if($claim->audited)
                                    <a
                                        href="{{url('/audit?claimid='.$claim->claimid)}}"
                                    ...
                                    @endif --}}
                                    <a
                                        href="{{url('/customers?claimid='.$claim->id)}}"
                                        class="btn btn-xs btn-flat btn-success"
                                        ><i class="fa fa-users"></i>
                                        Employees</a
                                    >
                                    <a
                                        href="{{url('/download/'.$claim->id.'/'.$claim->claimid)}}"
                                    ...
                                    <button
                                        ...
                                        onclick="showModal('{{$claim->id}}', '{{$claim->claimid}}')"
                                    >
                                        <i class="fa fa-info-circle"></i> Report
                                        Issue
                                    </button>
                                    @endif @if($claim->processed == false)
                                    ...
                                    @endif {{-- @role('accounting')
                                    @if($claim->audited && !$claim->paid)
                                    <button
                                        onclick="receiveClaim('{{$claim->id}}')"
                                        class="btn btn-xs btn-flat btn-primary"
                                    >
                                        <i class="fa fa-upload"></i> Receive
                                        Claim
                                    </button>
                                    @endif @endrole --}}
                                    <a
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        ></textarea>
                        <small
                            >Enter a short description of issue on claim.</small
                        >
                    </div>
                </div>
