...
@section('pageheading', 'Processed Files')
 ...
 <div class="col-md-8">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Upload Processed Files</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="{{url('/processed-files')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
